               ...
               echo "<table>"; 
                Switch($opt){
                        ...
                        if($qry->nrw){
                                ...
                                echo "        <th align='center' width='40'><b>Valor</b></th>";
                                echo "        <th align='center' width='40'><b>Peso</b></th>";
                                ...
                                for($i=0;$i<$qry->nrw;$i++){
                                       ...
                                       // echo $sql;
                                        ...
                                        echo "        <td align='center'>".$vl_entrega."</td>";
                                        echo "        <td align='center'>".number_format($peso_entrega,2)."</td>";
                                ...
                                echo "        <td align='center'><b>".$Total_Valor."</b></td>";
