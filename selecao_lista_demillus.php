...
function validar_form_lista(){
	...
	if(cblista > 0){
		...
		document.form_lista.action='monta_lista_demillus.php';
		else if(op==3)
    ...
    <table>
      ...
      <tr>
		...
		combo("SELECT codigotipolista,nometipolista 
           FROM tbtipolista WHERE codigotipolista in(2,9,30,27,28,29,38) 
      ...
      <tr>
        ...
        <?php
             ...
             if(($op==1 || $op==2) && ($cblista==1 || $cblista==2 || $cblista==5 || $cblista==18)){
                ...
                where 
                tbbasearray.codbase =".$_SESSION['IDBASE']." and tbbase.ativa = 'S' order by nomebase";
