...
<td align=center><p><font size=6px>MONITORAMENTO DEMILLUS </font></td> 
			...
			if($qry->nrw){
				...
				//Última não conformidade realizda
						...
						$sql_foto = 	"select tbmovimento.idmovimento ,tbmovimento.foto,tbmovimento.dataoperacao,tbmovimento.horaoperacao,tbmovimento.idinterno 
										...
										order by tbmovimento.dataoperacao,tbmovimento.horaoperacao desc limit 24
     	 								";
				...
				echo "<table  class = 'psdgraphics-com-table'><tr>";
				...
				$qry_n_baixa->navega($z);
					   ...
					   $qry4->executa("SELECT numconta,primeiroenvelope from tbentrega WHERE idinterno = $id");
					   $numra = $qry4->data['numconta'];
					   $set = $qry4->data['primeiroenvelope'];
				   	if($z % 8 == 0){
				   		echo "</tr><tr>";
				   	}
					   echo "<td width = 12%>";
					  ...
					  echo $datamov.' RA'.$numra." S".$set." ".substr($ra,0,15);
					   echo "</td>";
