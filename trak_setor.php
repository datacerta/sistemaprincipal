...
$_Exec  = HOST."/rastreamento_setor.php";
// pega o header
...
<!-- Bootstrap core JavaScript
	...
	function verMapa(setor){
        url = 'rastreamento_setor.php?setor='+setor;
...
( function( $ ) {
	$(function() {
		$('.pesquisar').on('click',function(){
			url = 'rastreamento_setor.php?setores='+$('.setores').val()+'&listas='+$('.listas').val()+'&ra='+$('.ra').val()+'&camp='+$('.camp').prop( "checked" );
			window.open(url,'conteudoMapa');
		});
	});
} )( jQuery );
