...
?>
    <table width="800" align="left" border="0">
      <tr bgcolor="#eeeeee">
        <td align="center"><font size="6"><b><font size="4">..:: </font></b><font color="#990000" size="3"><b>Atribuir Protocolo Roubado</b></font></font><font size="4"><b> ::..</b></font></td>
      </tr>
    </table>
    ...
    <?
        if(isset($_POST['enviar'])){
           if(!empty($codigobarras)){
             $sql="update tbentrega set idtipomovimento = '891' where idexterno = '$codigobarras'";
             $qry->executa($sql);
             if($qry->res){
            ...
            $msg = 'Campo codigo de barras vazio';
           }
