...
<form name="exporta_Redecard" action="exporta_demillus_final_novo_b.php?op=<?$setor?>&token=<?=$rnd?>" method="post"  onsubmit="return Validar(document.exporta_Redecard)">
...
<table>
	...
	<tr>
	   <td colspan="6" align="center">
	       <input type=submit class="submit" value="Gerar Arquivo para DeMillus, Ap&oacute;s gera&ccedil;&atilde;o favor enviar para Site DeMillus Teste" />
	   </td>
	</tr>
    </table>
</form>
